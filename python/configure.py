...
cmd = " ".join([config.sip_bin, "-c", ".", "-b", build_file, "-I", config.pyqt_sip_dir, pyqt_sip_flags, "../fakevim.sip"])
print("Executing: " + cmd)
os.system(cmd)
...
installs.append(["../fakevim.sip", os.path.join(config.default_sip_dir, "fakevim")])

installs.append(["fakevimconfig.py", config.default_mod_dir])
